...
namespace GameDesign
{
    class ZoneCreator : Selectors
    {
        ...
        public override void Update(MouseState mouseState, MouseState prevMouseState, Tile selectedTile)
        {
            ...
            {
                IEnumerable<Tile> query = from t in GameValues.tiles where drawRectangle.Contains(t.rectangle.Location) && t.layer == firstSelection.layer && t.layer == secondSelection.layer && !(t.type == Type.grass || t.type == Type.wall) select t;
